  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Restaurant booking engine - Simplifying table reservations and menu management for restaurants, while providing customers an effortless way to secure their seats. Experience dining redefined."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Restaurant booking engine - Simplifying table reservations and menu management for restaurants, while providing customers an effortless way to secure their seats. Experience dining redefined.`}
            </Text>
            <Box
