...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'Order #123 has been placed by Customer John Doe.create': {
    roles: ['chef', 'waiter', 'restaurant-manager', 'restaurant-owner', 'back-office'],
    key: 'order_create',
    tenantPath: [],
    userPath: [],
  },
  'Reservation #456 has been made by Customer Jane Doe.create': {
    roles: ['wait-staff', 'restaurant-manager', 'restaurant-owner', 'back-office'],
    key: 'reservation_create',
    tenantPath: [],
    userPath: [],
  },
  'Feedback #789 has been received from Customer John Doe.create': {
    roles: ['restaurant-manager', 'restaurant-owner', 'back-office'],
    key: 'feedback_create',
    tenantPath: [],
    userPath: [],
  },
